...
import { LightColors, DarkColors, Typography, Spacing, Radii, Shadows } from "../../theme/theme";
...
export default function ProfileScreen() {
  ...
  // ✅ Computed here so every render picks up the current theme
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.achieveGrid}>
          {engine.achievements.map((badgeItem, index) => (
            <View
              key={index}
              style={[styles.achieveBox, { backgroundColor: badgeItem.unlocked ? badgeItem.color : "#E5E7EB", opacity: badgeItem.unlocked ? 1 : 0.55 }]}
            >
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.8}
          onPress={() => { engine.logout(); router.replace("/(auth)/login"); }}
        >
...
// ✅ makeStyles factory — called inside component, not at module level
const makeStyles = (Colors: typeof LightColors) =>
  StyleSheet.create({
    ...
    centerWrapper: { flex: 1, alignItems: "center", justifyContent: "center", padding: Spacing.xl, marginTop: 100 },
    ...
    settingsGroupCard: { borderRadius: Radii.md, borderWidth: 3, ...Shadows.hardMd, marginTop: Spacing.md, overflow: "hidden" },
    ...
    settingsRowText: { fontFamily: Typography.fontBody, fontSize: Typography.size.base, fontWeight: "800" },

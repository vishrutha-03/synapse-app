...
import { Typography, Spacing, Radii, Shadows, LightColors, DarkColors } from "../../theme/theme";
...
export default function DecksScreen() {
  ...
  // ✅ Styles memoized — only recomputes when theme changes
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        >
          {FILTER_OPTIONS.map((f) => {
            ...
            return (
              <TouchableOpacity
                key={f}
                onPress={() => engine.setActiveFilter(f)}
        ...
        {engine.loading ? (
          ...
          <Text style={styles.emptyFeedbackText}>
            No decks found. Upload a file to get started!
          </Text>
        ) : (
          <View style={styles.decksGridStack}>
            {engine.decks.map((deck) => (
              <DeckCard
                ...
                onOptionsPress={() => handleDeckOptionsTrigger(deck)}
              />
            ))}
          </View>
        )}
            ...
            {!isEditingMode ? (
              <View style={styles.sheetLayoutStack}>
                ...
                <Text style={styles.sheetSubtitle}>
                  Manage or remove your active flashcard directory collection.
                </Text>

                <TouchableOpacity
                  style={styles.sheetActionRowBtn}
                ...
                <TouchableOpacity
                  style={[styles.sheetActionRowBtn, styles.sheetActionDangerBtn]}
                  onPress={executeDeckDelete}
                >
                  <Text style={[styles.sheetActionText, { color: "#FF4D6D" }]}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => setManageDeckModal(false)}
                >
...
// ✅ Factory — never called at module level

...
// ✅ No hooks, no Colors reference at module level — everything inside the component
...
export default function Upload() {
  ...
  // ✅ Styles memoized with primitive dep
        ...
        <View style={styles.methodGrid}>
          {METHODS.map((m, i) => (
            <TouchableOpacity
              ...
              onPress={() => {
                if (m.label === "Image Scan") pickImage();
              }}
            >
...
const makeStyles = (Colors: typeof LightColors) =>
  StyleSheet.create({
    ...
    methodGrid: { flexDirection: "row", flexWrap: "wrap", gap: Spacing.sm, marginTop: Spacing.lg },
    methodCard: {
      width: "47%",
    ...
    outputRow: { flexDirection: "row", alignItems: "center", gap: Spacing.md, marginBottom: Spacing.sm },
